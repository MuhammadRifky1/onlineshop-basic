...
<?php 
	$result = $conn->query("SELECT * FROM items LIMIT 4");
	while ($row = $result->fetch()) {
	
	?>
					<div class="four-item">
						<img src="images/items/<?php echo $row['foto'] ?>" width="90%" style="border: 1px #e0e0e0 solid;">
						<p class="item-name"><?php echo $row['nama_item'] ?></p>
						<p class="item-price">Rp. <?php echo number_format($row['harga'],0,".","."); ?></p>
